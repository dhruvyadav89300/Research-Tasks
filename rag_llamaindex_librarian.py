...
get_ipython().run_line_magic('pip', 'install -q      llama-index      EbookLib      html2text      llama-index-embeddings-huggingface      llama-index-llms-ollama')
...
get_ipython().system('apt install pciutils lshw')
...
get_ipython().system('ollama pull llama2')
...
get_ipython().system('mkdir -p "./test/library/jane-austen"')
get_ipython().system('mkdir -p "./test/library/victor-hugo"')
get_ipython().system('wget https://www.gutenberg.org/ebooks/1342.epub.noimages -O "./test/library/jane-austen/pride-and-prejudice.epub"')
get_ipython().system('wget https://www.gutenberg.org/ebooks/135.epub.noimages -O "./test/library/victor-hugo/les-miserables.epub"')
